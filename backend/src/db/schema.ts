...
export const rooms = pgTable('rooms', {
  ...
  baseRateRupees: paiseMoney('base_rate_paise').notNull(),
...
export const ratePlans = pgTable('rate_plans', {
  ...
  name: text('name').notNull(),
  roomType: text('room_type').notNull(),
  rateRupees: paiseMoney('rate_paise').notNull(),
...
export const reservations = pgTable('reservations', {
  ...
  nightlyRateRupees: paiseMoney('nightly_rate_paise').notNull().default(0),
  taxRateBps: integer('tax_rate_bps').notNull().default(0),
  estimatedTotalRupees: paiseMoney('estimated_total_paise').notNull().default(0),
  ...
  totalAmountRupees: paiseMoney('total_amount_paise').notNull(),
  balanceRupees: paiseMoney('balance_paise').notNull(),
...
export const folios = pgTable('folios', {
  ...
  status: text('status').notNull(),
  subtotalRupees: paiseMoney('subtotal_paise').notNull(),
  taxRupees: paiseMoney('tax_paise').notNull(),
  totalRupees: paiseMoney('total_paise').notNull(),
  discountRupees: paiseMoney('discount_paise').notNull().default(0),
  taxableAmountRupees: paiseMoney('taxable_amount_paise').notNull().default(0),
  cgstRupees: paiseMoney('cgst_paise').notNull().default(0),
  sgstRupees: paiseMoney('sgst_paise').notNull().default(0),
  igstRupees: paiseMoney('igst_paise').notNull().default(0),
  paidRupees: paiseMoney('paid_paise').notNull().default(0),
  refundedRupees: paiseMoney('refunded_paise').notNull().default(0),
  outstandingRupees: paiseMoney('outstanding_paise').notNull().default(0),
...
export const folioLines = pgTable('folio_lines', {
  ...
  unitAmountRupees: paiseMoney('unit_amount_paise').notNull(),
  taxRateBps: integer('tax_rate_bps').notNull(),
  lineTotalRupees: paiseMoney('line_total_paise').notNull(),
  subtotalRupees: paiseMoney('subtotal_paise').notNull().default(0),
  discountRupees: paiseMoney('discount_paise').notNull().default(0),
  taxableAmountRupees: paiseMoney('taxable_amount_paise').notNull().default(0),
  taxRupees: paiseMoney('tax_paise').notNull().default(0),
  cgstRupees: paiseMoney('cgst_paise').notNull().default(0),
  sgstRupees: paiseMoney('sgst_paise').notNull().default(0),
  igstRupees: paiseMoney('igst_paise').notNull().default(0),
...
export const payments = pgTable('payments', {
  ...
  amountRupees: paiseMoney('amount_paise').notNull(),
...
export const paymentRefunds = pgTable('payment_refunds', {
  ...
  paymentId: text('payment_id').notNull().references(() => payments.id), amountRupees: paiseMoney('amount_paise').notNull(), reason: text('reason').notNull(),
...
export const invoices = pgTable('invoices', {
  ...
  subtotalRupees: paiseMoney('subtotal_paise').notNull(), discountRupees: paiseMoney('discount_paise').notNull(), taxableAmountRupees: paiseMoney('taxable_amount_paise').notNull(), cgstRupees: paiseMoney('cgst_paise').notNull(), sgstRupees: paiseMoney('sgst_paise').notNull(), igstRupees: paiseMoney('igst_paise').notNull(), grandTotalRupees: paiseMoney('grand_total_paise').notNull(),
...
export const offlineBills = pgTable('offline_bills', {
  ...
  localAmountRupees: paiseMoney('local_amount_paise').notNull(),
  taxRupees: paiseMoney('tax_paise').notNull(),
  cloudAmountRupees: paiseMoney('cloud_amount_paise'),
...
export const damagePolicyRules = pgTable('damage_policy_rules', {
  ...
  liabilityCapRupees: paiseMoney('liability_cap_paise').notNull(),
...
export const damageReports = pgTable('damage_reports', {
  ...
  policyLiabilityRupees: paiseMoney('policy_liability_paise'),
  repairCostRupees: paiseMoney('repair_cost_paise'),
  chargeAmountRupees: paiseMoney('charge_amount_paise'),
...
export const inventoryItems = pgTable('inventory_items', {
  ...
  unitCostRupees: paiseMoney('unit_cost_paise').notNull(),
  updatedAt: text('updated_at').notNull(),
}, (table) => [
...
export const restaurantOrders = pgTable('restaurant_orders', {
  ...
  check('chk_restaurant_orders_paid_paise', sql`${table.paidRupees} >= 0 and ${table.paidRupees} <= ${table.totalRupees}`),
]);
...
export const restaurantOrderItems = pgTable('restaurant_order_items', {
  ...
  category: text('category').notNull(),
  quantity: integer('quantity').notNull(),
  unitPriceRupees: paiseMoney('unit_price_paise').notNull(),
  taxRateBps: integer('tax_rate_bps').notNull(),
  subtotalRupees: paiseMoney('subtotal_paise').notNull(),
  taxableAmountRupees: paiseMoney('taxable_amount_paise').notNull(),
  taxRupees: paiseMoney('tax_paise').notNull(),
  cgstRupees: paiseMoney('cgst_paise').notNull().default(0),
  sgstRupees: paiseMoney('sgst_paise').notNull().default(0),
  igstRupees: paiseMoney('igst_paise').notNull().default(0),
...
export const travelPackages = pgTable('travel_packages', {
  ...
  sellingPriceRupees: paiseMoney('selling_price_paise').notNull(),
  status: text('status').notNull(),
}, (table) => [
...
export const customTravelPackages = pgTable('custom_travel_packages', {
  ...
  assetSubtotalRupees: paiseMoney('asset_subtotal_paise').notNull(),
  basePriceRupees: paiseMoney('base_price_paise').notNull(),
  floorPriceRupees: paiseMoney('floor_price_paise').notNull(),
  quotedPriceRupees: paiseMoney('quoted_price_paise').notNull(),
  status: text('status').notNull(),
  version: integer('version').notNull().default(1),
  createdAt: text('created_at').notNull(),
  updatedAt: text('updated_at').notNull(),
...
export const travelDiscountRequests = pgTable('travel_discount_requests', {
  ...
  requestedPriceRupees: paiseMoney('requested_price_paise').notNull(),
  basePriceRupees: paiseMoney('base_price_paise').notNull(),
  floorPriceRupees: paiseMoney('floor_price_paise').notNull(),
...
export const inquiries = pgTable('inquiries', {
  ...
  estimatedValueRupees: paiseMoney('estimated_value_paise').notNull(),
  status: text('status').notNull(),
