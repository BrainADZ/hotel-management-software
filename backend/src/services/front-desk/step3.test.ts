...
import { guestInputSchema, guestListSchema, identityDocumentSchema, maskedIdentityNumber } from '@/services/guests/validation';
...
import { plannedPropertyTime } from './service';

describe('Step 3 validation and permission boundaries',()=>{
 it('normalizes single-digit property timezone offsets',()=>expect(plannedPropertyTime('2026-09-09','14:00','Asia/Kolkata')).toBe('2026-09-09T08:30:00.000Z'));
 it.each([
